...
label backto_palace:
    ...
    menu:
        ...
        "Tell a Lie":
            ...
            f "(Voice with false sympathy) There's… there's something else I need to tell you. She hesitates, then blurts out, Alma… she… she didn't make it."
...
label coronation_time:
    ...
    a "The people of Arendelle deserve a true leader, not a… a monster!"
    ...
    menu:
            ...
            "Argue with Alma":
                ...
                e "(screams) ENOUGH!"
                "Ella froze half of the Arendelle due to her explosion."
                jump argue
